...
/**
 * @description - Contains a set of notifications and the title
 *
...
export default class NotificationContainer extends PureComponent {
  ...
  /**
   * @description - Handles the iteration of pending  or general notifications
   *
   * @returns {array} list of pending notificxarions
   *
   */
